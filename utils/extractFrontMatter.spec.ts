  ...
  describe("Scenario 1 - Blue sky", () => {
    it("Runs write file  and append file for each file", async () => {
      const writeFile = vitest.fn<
        Parameters<WriteFileFn>,
        ReturnType<WriteFileFn>
      >();
      const appendFile = vitest.fn<
        Parameters<AppendIndexFileFn>,
        ReturnType<AppendIndexFileFn>
      >();
      const createSubfolder = vitest
        .fn<Parameters<CreateSubfolderFn>, ReturnType<CreateSubfolderFn>>()
        .mockImplementation((subPath) => {
      ...
      expect(writeFile).toHaveBeenCalledWith("generated/bar/a.json", "bar/a", {
        meta: {
          dateCreated: new Date("2022-11-28T00:00:00.000Z"),
          description: "I am description A",
          title: "I am title A",
        },
        tags: ["foo", "bar"],
      });
      expect(writeFile).toHaveBeenCalledWith("generated/bar/b.json", "bar/b", {
        meta: {
          dateCreated: new Date("2022-11-28T00:00:00.000Z"),
      ...
      expect(writeFile).toHaveBeenCalledWith("generated/foo/c.json", "foo/c", {
        meta: {
          dateCreated: new Date("2022-11-28T00:00:00.000Z"),
      ...
      expect(writeFile).toHaveBeenCalledWith("generated/foo/d.json", "foo/d", {
        meta: {
          dateCreated: new Date("2022-11-28T00:00:00.000Z"),
