...
export function RenderTracker(props) {
  ...
  return (
    <div className="render-tracker">
      ...
      <p className="mount-value">
        {mountValue === 0 ? (
          <>&#8203;</>
        ) : (
          <>Mount value: {mountValue.toFixed(4)}</>
        )}
      </p>
    ...
    <div className="render-tracker-demo">
      ...
      <button
        onClick={() => {
          ...
          console.log(
            style1.propsDotChildren[i] === style1.propsDotChildren[j]
          );
          ...
          console.log(
            style2.propsDotChildren[x] === style2.propsDotChildren[y]
          );
