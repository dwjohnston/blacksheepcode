  ...
  return (
    <html lang="en">
      <head>
        ...
        <script
          async
          src="https://www.googletagmanager.com/gtag/js?id=G-0NB66YHJYM"
        ></script>
        <script
      ...
      <body className={inter.className}>
          ...
          <div className="header-flex-container">
            ...
            <div className="icon-links">
              ...
              <a href="/rss.xml" className="rss-link" aria-label="rss feed">
                <span className="icon material-symbols-outlined">rss_feed</span>
              </a>
            </div>
            <Nav />
          </div>
        ...
        <MyTextHighlightProvider>{children}</MyTextHighlightProvider>
      </body>
    </html>
  );
}
