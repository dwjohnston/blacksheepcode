...
export default async function PageLayout() {
  ...
  return (
    <div>
      ...
      <GithubPermalinkRsc
        permalink="https://github.com/dwjohnston/bundle-size-investigation/blob/37f8511bb56a556b1abd2c87226847e2ef30e07f/scenario-1-images-only/index.html#L1-L31"
        excludeLines={[[4, 5]]}
      />
    </div>
  );
