...
<img src={horseshoe1.src} alt="Typical business processes workflow" className="blog-image invert-colors-on-dark"/>
...
<img src={horseshoe2.src} alt="What happens in practise" className="blog-image invert-colors-on-dark"/>
...
<img src={horseshoe3.src} alt="I suggest a horseshoe model" className="blog-image invert-colors-on-dark"/>
