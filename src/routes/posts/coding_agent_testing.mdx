---
meta:
  title: Does this tool exist? A tool for comparing/testing the difference between LLM harnesses, models and prompts
  description: All the talk in the world of what certain prompting techniques, or models, workflow strategies isn't very useful unless you can actually measure it 
