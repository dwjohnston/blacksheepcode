---
meta:
  title: I'm apprehensive about using too many AI images in my blog. 
...
It's nice to have a social preview that isn't the regular site logo, and images serve to break up the screen and have the user not be faced with a wall of text. 
...
AI generated images poses a really easy solution to this - I can quickly and easily generate images that relevant to the content, it'll break up the walls of text the blog will look better. 

But, I feel like it'll tarnish the blog, the blog will have this samey look of 'yet-more-ai-slop-everywhere'. 
