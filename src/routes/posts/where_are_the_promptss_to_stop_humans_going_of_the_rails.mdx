...
But humans can be just as tempremental, if not more. Sometimes we're under pressure, or we're just tired, and can think 'TDD will take too long, let me just get this thing working first'*
...
There are equivilent tools in other industries - vigilance switches on trains come to mind, where the the device will make an annoying sound and the driver must press a button to prove they are still awake, otherwise the train comes to a stop. 
