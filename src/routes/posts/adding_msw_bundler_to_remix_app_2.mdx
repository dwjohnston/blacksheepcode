...
<Aside>
  ...
  <p>But right now, I don't care enough. The code is tested, and my philosophy is that '[good code is easy to delete](./well_designed_code_is_easy_to_delete)', the interface is fine, we can rewrite this later if we need.</p>
</Aside>
