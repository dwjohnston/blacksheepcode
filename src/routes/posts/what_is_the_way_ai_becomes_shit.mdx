...
Then, at some point user growth platues and the company switches to a 'extract value for the large user base'. 
...
Then, at some point user growth plataues and then... 
...
They of course have a strong incentive to have users user _more_ tokens, not less!

Going back to Facebook - Facebook had every incentive not to have users connect with each other, get off their computers and meet up in the park, at which point they stop viewing the Facebook ads, they had every incentive to instead keep users to just keep the users scrolling. 
