...
The idea here is that the AI companies are making money by having users use the products. Either because they're directly profiting per token used, or because theres some ad supported model.
