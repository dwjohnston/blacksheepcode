...
Then, at some point user growth plateaus and the company switches to a 'extract value from their large user base'. 
...
Now you might say 'skill issue' - but the point here is that the AI companies don't necesserily have the incentive to have people use their products efficiently. 
