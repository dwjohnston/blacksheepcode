...
---
import blindfold from "@/assets/ai_generated_blindfold.jpeg";
...
<img src ={blindfold.src} alt="ai generated image. A man is crouching in a messy room surrounded by books and computer in the background. He is wearing a device over his eyes which appears appears some kind of graphic interface." className="blog-image" style={{height: 400, display: "block", margin: "40px auto"}}/>
