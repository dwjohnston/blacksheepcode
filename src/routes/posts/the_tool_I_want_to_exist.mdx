---
meta:
  title: The tool I want to exist
  description: I want some kind of API mocking tool that can monitor real world API usage to produce its mocks
...
I like API mocking tools, I think the approach of 'including your state management as an implicit part of the test' works, and that's not the part that makes testing difficult. (Unless the state management layer contains a lot of convoluted business logic - in which case [see this post](https://blacksheepcode.com/posts/dependency_injecting_when_using_redux).)
...
- useUser could encounter a 500
- useUser could encounter a 403
- useUser could be successful and return an admin user
- useUser could be successful and return a non-admin users

- useTodos could encounter a 500
- useTodos could encounter a 403
- useTodos could return an empty list
- useTodos could return a single page of todos
- useTodos could return the first page of many pages

- useUpdateTodosMutation could encounter a 500
- useUpdateTodosMutation could encounter a 403
- useUpdateTodosMutation could encounter a 400
- useUpdateTodosMutation return successful
...
## Do you know of an existing tool? 
