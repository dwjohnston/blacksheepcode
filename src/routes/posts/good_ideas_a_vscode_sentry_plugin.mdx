...
Such reporting does not just need to exist for thrown errors, possibly if we found that often users without IDs were existing, we might just the code to:
