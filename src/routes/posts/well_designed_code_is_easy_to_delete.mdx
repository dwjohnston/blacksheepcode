...
I've been seeing a growing narrative recently that makes the argument 'focus on shipping / focus on solving customer's problems / the focus on clean code is a distraction that prevents you from delivering value to the business'. 
...
This is obviously a somewhat radical and provocative idea, but it has some merit. 
...
The idea is, that will lend itself to shortcuts being taken, and tight coupling occurring, for the sake of some convenience. 

Whereas, if the interaction between two different services, is between two different teams, then each has the incentive to keep the interface coherent. 
