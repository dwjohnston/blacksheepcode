...
<img src={ss1.src} alt="Screenshot of the connect github dialog" className="blog-image"/>
...
<img src={ss1.src} alt="Screenshot of the commit panel" className="blog-image"/>
...
<img src={ss1.src} alt="Screenshot of erroneous query parameters" className="blog-image"/>
