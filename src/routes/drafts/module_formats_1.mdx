Let's start with using TypeSciript as our compiler. 
...
We get a whole lot of polyfill logic to implement generate and awaitng logic. 
...
TypeScript drops the import, and we do not get the side effect of the import occuring. 
