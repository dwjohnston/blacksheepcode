...
Well OK, it's not quite that simple. Software engineering as a discipline is in its infancy - civil engineering has thousands of years more experience on it. It's the norm of software to be continually evolving, having additional requirements etc, where a bridge typically is built and left alone. 
...
I want to make the argument that software development is inherently a messy discipline, and outside of a small application like a tic-tac-toe game or tutorial, perfect codebases simply do not exist. 
...
Also, perhaps I'm viewing non-software engineers through a perfect lens, perhaps there plenty of frustrations in the non-software engineering space that I'm simply not privy to - what comes to mind is criticisms of car designers making the job of mechaninics difficult. 
