...
In a RESTful API we could use a <TextHighlight comment={<><p>
  Note the use of HTTP semantics! We know that a partial update is supported by the established convention of HTTP semantics.
</p>
...
This is what's known as a <TextHighlight comment={<>
<p>
