...
The issue with the Cypress tests is the most disconcerting part of this experiencing. 

Practically speaking - this is a small blog, I can verify that things are working manually, and even if I break things it doesn't really matter. 

But imagine we scale this up - it's a larger Remix code base with Cypress tests - there might quite a lot of tests that I'm having to skip. 

We could look at Playwright - see if it handles this better - but rewriting _all_ of your tests to do a migration seems like a step in the wrong direction. 
