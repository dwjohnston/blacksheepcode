...
Table of contents is reproduced pretty straight forward. 


14. Common post layout 
...
replace link. 
convert frontmatter box to async comp


https://github.com/vercel/next.js/discussions/64753


Alright, this isn't going to work, I need to do a proper fledged do my own MDX solution. 
