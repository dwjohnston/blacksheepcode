...
This goes pretty smoothly. 

I don't really have a way of automating that it's configured correctly. My way to do is to have a secret page that will intentionally error and check that it is erroring in production. 
