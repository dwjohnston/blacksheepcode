...
Unless you are YOLOing it and creating a codebase that is not read by humans at all, 
...
Where this comes around to, is that I don't quite understand how people are using huge numbers of tokens. I see people mentioning that they've got multiple things happening simultaneously. 

I can accept that there's a large amount of not reading the code, but then the question is still 'well how do you know the application works'? 