...
Importantly this will isolate our application from the internet at large, we rely on AWS's infrastructure to prevent the items in our VPC being probed by the wider internet. 
...
<GithubPermalink permalink="https://github.com/dwjohnston/load-testing-with-k6/blob/7faa1c20ac54a8780d62deeab6a9738a5c2618c1/infra/main.ts#L360-L365"/>
