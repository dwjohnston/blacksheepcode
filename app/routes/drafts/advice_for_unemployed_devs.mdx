...
- "Considered GraphQL and NextJS as a solution for performance bottlenecks" for another of the jobs. Now note that I didn't actually do any testing or write any documentation or anything, hence using the word 'considered';  I did think about it in the shower, I did have conversations with people about how NextJS could reduce the impact of serial data loading waterfalls by reducing the network round trip time. 
