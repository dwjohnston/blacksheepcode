...
The spec we will use is the [petstore example](https://github.com/OAI/OpenAPI-Specification/tree/main/examples/v2.0/yaml/petstore-separate) taken from OpenAPI's docs.
...
```
openapi-generator-cli generate -g go-server -o ./backend -i ./spec/petstore-separate/spec/swagger.json 
```
...
```
openapi-generator-cli generate -g typescript-fetch -o ./frontend/src/generated -i ./spec/petstore-separate/spec/swagger.json 
```
...
In future posts we'll delve deeper into how useful approach in practise. 
