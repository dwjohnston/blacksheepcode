...
meta:
  ...
  description: Making changes in an extensible manner avoids having to do signficant code rewrites or being disruptive to downstream consumers of your API.
