...
```
msw-auto-mock ../spec/petstore-separate/spec/swagger.json -o src/generated/msw.js --base-url '/api'
```
...
msw-auto-mock does not currently support multiple examples, which might make this limiting for more comprehensive teseting. In that case you might need to get creative and/or extend the functionality of what msw-auto-mock is providing. 