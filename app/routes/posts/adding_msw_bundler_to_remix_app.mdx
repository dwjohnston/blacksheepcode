...
meta:
  ...
  description: I've switched this blog to using Remix and mdx-bundler to make better use of frontmatter headers. This will allow adding publication dates, or grouping posts into series, adding tags, etc.
...
<InfoPanel level="warning">
<p>This solution is works for mdx-bundler@9.2.1. See [this issue re: 10.0.0.](https://github.com/kentcdodds/mdx-bundler/issues/217)</p>
</InfoPanel>
...
We now handle any requests for our blog posts with `$.tsx` handler. We just pass the entire slug to our utility funtion, and ask it to return the component and frontmatter. 
