---
meta:
  twitter:title: Postman and OpenAPI 
  twitter:description: Syncing Postman with our Github repo, generating queries from our OpenAPI spec
...
### 1. Create a postman account, create a teeam, create a workspace
...
<img src={ss3} alt="Screenshot of eroneous query parameters" className="blog-image"/>
